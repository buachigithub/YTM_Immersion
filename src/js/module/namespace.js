...
const YTMLog = (() => {
  ...
  let config = {
    ...
    // Custom KPoe / LyricsPlus 互換サーバー。既定は無効で、設定パネルから
    // 有効化した人だけが使う。URL はサーバーのホスト:ポートを想定する。
    kpoeEnabled: false,
    kpoeBaseUrl: 'http://localhost:3946',
  ...
  const LOCAL_FALLBACK_TEXTS = {
    ja: {
      ...
      settings_source_auto_desc: "優先する取得元を選びます。選んだ側で取れなかった曲は、自動でもう一方（と LrcLib / KPoe）に切り替わります。",
      settings_source_ytm: "YouTube Music 優先",
      settings_source_lrchub: "LRC Hub 優先",
      settings_source_kpoe: "Custom KPoe 優先",
      settings_kpoe_enable: "Custom KPoe を使う",
      settings_kpoe_url: "KPoe サーバー URL",
      settings_kpoe_url_desc: "Custom KPoe / LyricsPlus 互換サーバーのアドレス（例: http://localhost:3946）",
    ...
    en: {
      ...
      settings_source_auto_desc: "Choose which source to try first. If it has nothing for a song, the other one (and LrcLib / KPoe) is used automatically.",
      settings_source_ytm: "Prefer YouTube Music",
      settings_source_lrchub: "Prefer LRC Hub",
      settings_source_kpoe: "Prefer Custom KPoe",
      settings_kpoe_enable: "Use Custom KPoe",
      settings_kpoe_url: "KPoe server URL",
      settings_kpoe_url_desc: "Address of a Custom KPoe / LyricsPlus compatible server (e.g. http://localhost:3946)",
    ...
    ko: {
      ...
      settings_source_auto_desc: "먼저 사용할 소스를 선택합니다. 선택한 쪽에 가사가 없으면 다른 쪽(및 LrcLib / KPoe)으로 자동 전환됩니다.",
      settings_source_ytm: "YouTube Music 우선",
      settings_source_lrchub: "LRC Hub 우선",
      settings_source_kpoe: "Custom KPoe 우선",
      settings_kpoe_enable: "Custom KPoe 사용",
      settings_kpoe_url: "KPoe 서버 URL",
      settings_kpoe_url_desc: "Custom KPoe / LyricsPlus 호환 서버 주소 (예: http://localhost:3946)",
    ...
    zh: {
      ...
      settings_source_auto_desc: "选择优先使用的来源。若所选来源没有该歌曲，将自动切换到另一个来源（以及 LrcLib / KPoe）。",
      settings_source_ytm: "优先 YouTube Music",
      settings_source_lrchub: "优先 LRC Hub",
      settings_source_kpoe: "优先 Custom KPoe",
      settings_kpoe_enable: "使用 Custom KPoe",
      settings_kpoe_url: "KPoe 服务器 URL",
      settings_kpoe_url_desc: "Custom KPoe / LyricsPlus 兼容服务器地址（例如 http://localhost:3946）",
